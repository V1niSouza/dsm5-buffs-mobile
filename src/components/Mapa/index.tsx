...
export const MapLeaflet: React.FC<MapLeafletProps> = ({ piquetes }) => {
  ...
  // Cria os arrays de coordenadas e cores para cada piquete
    ...
    <html>
      ...
      <body>
        ...
        <script>
          ...
          // Adiciona os polígonos e calcula os bounds
          let allCoords = [];
          piquetes.forEach(p => {
  ...
  return <WebView ref={webviewRef} originWhitelist={['*']} source={{ html }} style={{ height: 690, width: '100%' }} />;  
};  
